...
(function() {
    ...
    angular
        ...
        .constant('PET_ROUTE', {
            ...
            UnloggedAbstract: 'unlgvendor',
            Registration: 'unlgvendor.reg',
            VendorAbstract: 'vendor',
            VendorLanding: 'vendor.landing',
            CommonAbstract: 'common',
            CommonButtons: 'common.buttons',
            CommonTypography: 'common.typography',
